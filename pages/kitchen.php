...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8">
        <title>Kitchen | Smart Home</title>
	...
	<div class="row row-offcanvas row-offcanvas-left">
		<div class="col-sm-3 col-md-3" id="sidebar" role="navigation">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="#"><img src="../source_files/kitchen.png" height="25" width="30" /> Kitchen</a></li>
...
<div class="col-sm- col-md-8 main">
          ...
          <i>Welcome to the kitchen area. To turn off/on lights use the switch. To open blinds click turn </i>
          <hr width="80%";
